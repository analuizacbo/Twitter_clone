<?php
    ...
    class Usuario extends Model{
        ...
        public function salvar(){
            $query = 'insert usuarios(nome,email,senha) values (:nome,:email,:senha)';
            $stmt = $this->db->prepare($query);
            $stmt->bindValue(':nome',$this->__get('nome'));
            $stmt->bindValue(':email',$this->__get('email'));
            //md5 criptografia hash 32 caracteres
        ...
        public function seguirUsuario($id_usuario_seguindo){
            //echo 'Seguir usuário';
            $query = "insert usuarios_seguidores (id_usuario, id_usuario_seguindo) values (:id_usuario, :id_usuario_seguindo)";

            $stmt = $this->db->prepare($query);
            $stmt->bindValue(':id_usuario', $this->__get('id'));//esse id é o da classe
